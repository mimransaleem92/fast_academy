...
class YAHOO_util_Loader {
    ...
    /**                                                                                            // Add by Fabio Ingala
    * The version of YUI PHPLoader                                                                 // Add by Fabio Ingala
    * @property loader_version                                                                     // Add by Fabio Ingala
    * @type string                                                                                 // Add by Fabio Ingala
    * @default                                                                                     // Add by Fabio Ingala
    */                                                                                             // Add by Fabio Ingala
    var $loader_version = "1.0.0b2";                                                               // Add by Fabio Ingala
    ...
    */
    function YAHOO_util_Loader($yuiVersion, $cacheKey=null, $modules=null, $noYUI=false) {
        ...
        */
        //$parentDir = dirname(dirname(__FILE__));                                                 // Original row - Edit by Fabio Ingala
        $parentDir = dirname(__FILE__);                                                            // Changed row  - Edit by Fabio Ingala
