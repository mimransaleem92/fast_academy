...
function onclick_update(){
	var val = document.getElementById('upload_file2').value;
	if(val.length < 5){
		document.getElementById('error_msg2').innerHTML = "Please select a file to update!";
		return false;
	}
	else
	{
...
//-->
		...
		<form id="frmUpload" method="post" action="<?php echo base_url();?>vouchers/upload_voucher" enctype="multipart/form-data">
			...
			<table id="form_tbl" width="98%" border="0" cellpadding="0" cellspacing="0" class="whitebgBorder" style="margin-top:2px; border:1px solid #8CBAE8;">
              	...
              	<tr style="height: 25px" >
                    <td align="left" nowrap="nowrap" style="padding:4px;">
					    <input type="submit" id="btn_new" style="width:85px;" class="field_big" value="Update" onclick="return onclick_update();" />
                        &nbsp;
