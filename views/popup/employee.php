...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="90%" border="0" cellspacing="0" cellpadding="0" style="cursor:pointer">
    	<tr>
            ...
            <td width="" class="frame_blue"><?php echo Base_Controller::ToggleLang('Employee Name');?></td>
        </tr>
        <tr>
        	<form id="frm" action="<?php echo base_url();?>popup/employee" method="post">
            ...
            ?>
		<tr>
			<td class="<?php echo $class; ?>"><input type="checkbox" name="selected_id_<?php echo $i;?>" id="selected_id_<?php echo $i;?>" value="<?php echo $values->employee_id;?>" onclick="assign_value(this,this.value, '<?php echo $values->employee_name;?>');"/></td>
            <td class="<?php echo $class; ?>" style="color:#888888;"><strong><?php echo $values->employee_id; ?></strong></td>
            <td class="<?php echo $class; ?>"><?php echo $values->employee_name; ?></td>                          
        </tr>
            <?php
				}
            }
