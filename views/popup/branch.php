...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function assign_value(obj, val, val2){
			...
			if(obj.checked){
				frm.branch_id.value = val;
				frm.branch_name.value = val2;
				self.close();
			}
		}	
	...
	<table width="80%" border="0" cellspacing="0" cellpadding="0" style="cursor:pointer">
    	<tr>
            ...
            <td width="" class="frame_blue"><?php echo Base_Controller::ToggleLang('Branch Name');?></td>
        </tr>
            <?php
            $i=0;
            ...
            ?>
		<tr>
			<td class="<?php echo $class; ?>"><input type="checkbox" name="selected_id_<?php echo $i;?>" id="selected_id_<?php echo $i;?>" value="<?php echo $values->branch_id;?>" onclick="assign_value(this,this.value, '<?php echo $values->name;?>');"/></td>
            <td class="<?php echo $class; ?>" style="color:#888888;"><strong><?php echo $values->branch_id; ?></strong></td>
