		...
		<div class="portlet-body" >
			<div class="form-group">
				<div class="col-md-5">
					...
					<div class="form-group">
						<input type="text" name="sponsor_name" id="sponsor_name" class="form-control" value="" />
				...
				<div class="col-md-offset-2 col-md-5">
					...
					<div class="form-group">
						<input type="text" name="number_of_chidren" id="number_of_chidren" data-required="1" class="form-control" value="<?php echo set_value('number_of_chidren');?>" >
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					...
					<div class="form-group">
						<input type="text" name="chidren_name" id="chidren_name" data-required="1" class="form-control" value="<?php echo set_value('chidren_name');?>" >
				...
				<div class="col-md-offset-2 col-md-5">
					...
					<div class="form-group">
						<input type="text" name="bank_ac_name" id="bank_ac_name" data-required="1" class="form-control" value="<?php echo set_value('bank_ac_name');?>" >
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					...
					<div class="form-group">
						<input type="text" name="bank_ac_number" id="bank_ac_number" data-required="1" class="form-control" value="<?php echo set_value('bank_ac_number');?>" >
				...
				<div class="col-md-offset-1 col-md-6">
					...
					<div class="form-group">
						<input type="text" name="license_moe" id="license_moe" data-required="1" class="form-control" value="<?php echo set_value('license_moe');?>" >
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="insurance_number" id="insurance_number" data-required="1" class="form-control" value="<?php echo set_value('insurance_number');?>" >
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="insurance_type" id="insurance_type" data-required="1" class="form-control" value="<?php echo set_value('insurance_type');?>" >
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="insurance_expiry" id="insurance_expiry" data-required="1" class="form-control form-control-inline date-picker"  data-date-format="dd-mm-yyyy" size="16" value="<?php echo set_value('insurance_expiry');?>" >
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="visa_status" id="visa_status" data-required="1" class="form-control" value="<?php echo set_value('visa_status');?>" >
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="annual_leave_entitlement" id="annual_leave_entitlement" data-required="1" class="form-control" value="<?php echo set_value('annual_leave_entitlement');?>" >
				...
				<div class="col-md-4">
					...
					<div class="form-group">
						<input type="text" name="number_of_tickets" id="number_of_tickets" data-required="1" class="form-control" placeholder="" value="<?php echo set_value('number_of_tickets');?>" >
