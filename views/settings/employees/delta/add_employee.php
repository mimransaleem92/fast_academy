...
<br/>
<a class="btn btn-xs blue" href="<?php echo base_url().$model.''; ?>" target="_self" >New Employee</a>
...
<?php }else{?>
<?php echo form_open('add_employee',array('id'=>'mainForm', 'enctype'=>"multipart/form-data")); ?>
