				...
				<table class="table table-condensed">
					<tbody>
					       	...
					       	<td>
					       		<select name="subject_id" class="form-control select2me" id="subject_id" >
				                    ...
				                    <?php foreach($course_subject as $sub){ 
				                    	...
				                    	?> 
				                    	<option value="<?php echo $subject_id;?>" <?php echo ($form->subject_id == $subject_id) ? 'selected="selected"':'';?>><?php echo $sub->subject_name;?></option>
				                    <?php } ?>
								</select>
					       	</td>
				       </tr>
				       <tr> 
				       		...
				       		<td>
				       			<div class="input-group date form_meridian_datetime" data-date="<?php if($form->start_time != '0000-00-00 00:00:00') echo $form->start_time;?>">                                       
									<input type="text" size="16" readonly class="form-control" id="start_time" name="start_time" value="<?php if($form->start_time != '0000-00-00 00:00:00')  echo $form->start_time;?>">
				       ...
				       <tr> 
				       		...
				       		<td><!-- <input type="text" class="form-control form-control-inline date-picker"  data-date-format="dd-mm-yyyy" size="16" id="exam_date" name="exam_date" value=''  /> -->
				       			<div class="input-group date form_meridian_datetime" data-date="<?php if($form->end_time != '0000-00-00 00:00:00') echo $form->end_time;?>">                                       
									<input type="text" size="16" readonly class="form-control" id="end_time" name="end_time" value="<?php if($form->end_time != '0000-00-00 00:00:00')  echo $form->end_time;?>">
									<span class="input-group-btn">
									<button class="btn default date-reset" type="button"><i class="fa fa-times"></i></button>
									</span>
									<span class="input-group-btn">
				        ...
				        <tr> 
				       		...
				       		<td><input type="text" class="form-control" id="max_marks" name="max_marks" value='<?php echo $form->max_marks;?>'  /></td>
				       </tr>
				        <tr> 
				       		<td><?php echo Base_Controller::ToggleLang('Min Marks');?></td>
				       		<td><input type="text" class="form-control" id="min_marks" name="min_marks" value='<?php echo $form->min_marks;?>'  /></td>
				       </tr>
				       <tr> 
				       		<td></td>
				       		<td>
