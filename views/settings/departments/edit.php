...
<div class="col-md-12">
	...
	<?php  
		    $form = $form[0];
		    echo form_open('department/update',array('id'=>'mainForm', 'class'=>"form-horizontal"));
		    echo form_hidden("department_id",$form->department_id);
	?>
		<div class="form-body">
			...
			<?php $field_list = $form->search_fields;
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="search_field1" data-required="1" class="form-control" placeholder="Enter Field Name" value="<?php if(isset($fields[0]))echo $fields[0];?>" >
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="search_field2" data-required="1" class="form-control" placeholder="Enter Field Name" value="<?php if(isset($fields[1]))echo $fields[1];?>" >
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="search_field3" data-required="1" class="form-control" placeholder="Enter Field Name" value="<?php if(isset($fields[2]))echo $fields[2];?>" >
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="search_field4" data-required="1" class="form-control" placeholder="Enter Field Name" value="<?php if(isset($fields[3]))echo $fields[3];?>" >
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="search_field5" data-required="1" class="form-control" placeholder="Enter Field Name" value="<?php if(isset($fields[4]))echo $fields[4];?>" >
					</div>
				</div>
			</div>
