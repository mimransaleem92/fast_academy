		...
		<tbody>					
			<?php $i=0; 
	            ...
	            <tr>
	                ...
	                <a class="btn default btn-xs green-stripe" href="<?php echo base_url().$model.'/reprint_card/'.$param.'?course_id='.$values->course_id.'&batch_id='.$values->batch_id;?>">Reprint</a>
	                <?php }else {?>
	                <a class="btn default btn-xs blue-stripe" href="<?php echo base_url().$model.'/print_card/'.$param.'?course_id='.$values->course_id.'&batch_id='.$values->batch_id;?>" target="_blank">Print</a>
	                <?php }?>
	                <!-- 
