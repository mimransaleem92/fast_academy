<div class="col-md-12">
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption"><i class="fa fa-picture"></i><?php echo Base_Controller::ToggleLang('New Section');?></div>
			<div class="tools">
		...
		<div class="portlet-body">
			...
			<?php 
			echo form_open('batches/add',array('id'=>'mainForm', 'class'=>"form-horizontal"));
			$batch_name     = array( 'name' => 'batch_name', 'id'   => 'batch_name', 'class' => 'form-control', 'value' => set_value('batch_name'));
			...
			?>
				<div class="form-body">
							...
							<div class="form-group">
								<select name="course_id" class="form-control select2me" id="course_id" >
				                    ...
				                    <?php foreach($courses_list as $course){ 
				                    	...
				                    	?> 
				                    	<option value="<?php echo $course_id;?>" <?php if( isset($_REQUEST['course_id']) && $course_id == $_REQUEST['course_id']) echo 'selected';?> ><?php echo $course->course_name;?></option>
				                    <?php } ?>
								</select>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="<?php echo Base_Controller::ToggleLang('Batch Name');?>" name="batch_name" id="batch_name" value='<?php if(isset($_REQUEST['batch_name'])) echo $_REQUEST['batch_name'];?>' />
