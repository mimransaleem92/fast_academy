...
<div class="tabbable tabbable-custom boxless">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					<?php $start = microtime(true); //$start = microtime(true); echo 'time_elapsed: '.$time_elapsed;
						$form = $form[0]; 
						...
						<div class="form-body">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control <?php if($super_admin == 'Y') echo 'form-control-inline date-picker'?>" data-date-format="dd-mm-yyyy" <?php if($super_admin == 'N') echo 'readonly="readonly"'?> id="payment_date" name="payment_date" value='<?php echo date('d-m-Y');?>' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								if( $student_division == 'DNS' ){
									...
									// change it because after 25% collection it is disappeare. reason other payments was through cheques but they collect manually
								...
								<div class="col-md-6">
									<div class="form-group" style="<?php echo $hide_payment_button;?>">
										<label class="control-label col-md-2"><?php // echo Base_Controller::ToggleLang('Payment');?></label>
										<div class="col-md-10">
											<div class="clearfix">
												...
												<div class="radio-list" >
													...
													<label class="radio-inline" style="<?php if($admin_role == '0') echo 'display:none;'?>" onclick="onclick_payment();" title="Manual fee">
													<input type="radio" style="<?php if($admin_role == '0') echo 'display:none;'?>" name="payment_amt" id="payment_amt999" value="999" > Manually
													</label> <?php } ?>
												</div> 
											</div>
										</div>
											...
											<?php  $payment_amount = 0;
												...
												{ 
													if($ratio < 75 ){
														...
														$payment_amount = $due_fee;
													}
												}
												?>
											<input type="hidden" id="payment_amount_hidden" value='<?php echo $payment_amount;?>' />
											<input type="text" class="form-control" style="text-align: right; padding-right: 4px" onkeyup="onkeyup_payment(this, event);" id="payment_amount" name="payment_amount" value='<?php echo $payment_amount;?>' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
...
<script src="<?php echo base_url();?>assets/scripts/app.js"></script>	
		<script> 
	        ...
	        function submitForm(){
				...
				//var after_discount_amt = payment_amt - parseFloat(discount_amt);
	        	//alert('sum_payments'+sum_payments);
	        	if(terms == '0' && fee_desc == '1'){
	        		document.getElementById('error1').innerHTML="No pending dues available for collection.";
	        		error1.show();
					...
					date_params = ['cheque_date', 'cheque_present_date', 'cheque_date1', 'present_date1', 'cheque_date2', 'present_date2', 'cheque_date3', 'present_date3'];
	        ...
	        function set_payment_amount(obj){
	        	...
	        	if(x == '1'){
					...
					document.getElementById('payment_amount').disabled = true;
					mode_obj.options[1].selected = true;
					mode_obj.options[0].disabled = true;
	        ...
	        function onclick_second_source(obj){
        		...
        		document.getElementById('cheque_option_row2').style.display = "none";
        		document.getElementById('cc_cheque_option_row2').style.display = "none";
        		document.getElementById('payment_mode_second').options[0].selected = true;
