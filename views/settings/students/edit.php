		...
		<div class="tab-pane active" id="tabs_0">	
			<div class="portlet box green">
				...
				<div class="portlet-body form">
					<!-- BEGIN FORM-->
					<?php echo form_open('students/update',array('id'=>'mainForm', 'enctype'=>"multipart/form-data", 'class'=>"form-horizontal")); $today = date('Y-m-d'); ?>
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php if(is_numeric($form->nationality)){?>
											...
											<?php } else {?>
											<input type="text" class="form-control" id="nationality" name="nationality" value='<?php echo $form->nationality;?>'/>
											<?php }?>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" class="form-control form-control-inline " data-required="1"  data-date-format="dd-mm-yyyy" size="10" placeholder="dd-mm-yyyy" id="iqama_expiry" name="iqama_expiry" value="<?php if(isset($form->iqama_expiry)) echo Util::displayFormat($form->iqama_expiry); ?>" placeholder="<?php echo Base_Controller::ToggleLang('00-00-0000');?>">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											...
											if(!empty($form->enrollment_grade_level)){ $enrollment_grade_level = $form->enrollment_grade_level; }
												...
												$enrollment_grade_level = 'Grade '.$form->course_id;
											}
											?>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control" style='font-family: "DroidKufi Regular", Tahoma; text-align: right;' id="previous_school_ar" name="previous_school_ar" value='<?php echo $form->previous_school_ar;?>' placeholder="<?php echo Base_Controller::ToggleLang('Previous School', 'ar');?>">
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-3"><?php echo Base_Controller::ToggleLang('Academic Year').' / '.Base_Controller::ToggleLang('Month');?>:</label>
										...
										<div class="col-md-2">
											<select name="admission_term" class="form-control" <?php if($super_admin == 'N') echo 'disabled'?> id="admission_term" data-placeholder="Choose a fee term" tabindex="1" >
												...
												for($m = 1; $m <= 12; $m++){
													$selected = ($m == $form->month) ? 'selected' : '';
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="control-label col-md-3">Continue Study</label>
										<div class="col-md-1">
										...
										<label class="control-label col-md-2">Fee Month</label>
										<div class="col-md-2">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control" name="cell_phone_father" id="cell_phone_father" value="<?php if(isset($form->cell_phone_father)) echo $form->cell_phone_father; ?>" placeholder="<?php echo Base_Controller::ToggleLang('Phone 1');?>"/>
										</div>
										<div class="col-md-3">
											<input type="text" class="form-control" id="cell_phone_mother" name="cell_phone_mother" value='<?php echo $form->cell_phone_mother;?>' placeholder="<?php echo Base_Controller::ToggleLang('Phone 2', 'ar');?>">
										</div>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="form-group col-md-5">
											...
											<div class="col-md-9">
												<input class="form-control input-sm" <?php if(isset($form->employee_kid) && $form->employee_kid == 'No') echo 'disabled="disabled"';?> name="discount_on_employee_kid" id="discount_on_employee_kid" maxlength="2" style="text-align: right;" value="<?php echo $form->discount_on_employee_kid;?>" placeholder="Percent"/>
											</div>
										</div>
										<div class="col-md-1"></div>
