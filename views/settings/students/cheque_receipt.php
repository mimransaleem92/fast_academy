...
<div class="col-md-12">
	...
	<div style="width:820px">
		<?php if(is_null($form2->due_amount)){?>
		...
		<?php } ?>
				<table class="table table-condensed" border="0">
					<tbody>
					   <tr> 
				       		<td></td>
					       	<td><u>Guarantee Cheque</u></td>
					       	<td><?php echo Base_Controller::ToggleLang('Received on').": <u>". Util::dateDisplayFormateWithTime($form2->created_date) . "</u>";?></td>
				       </tr>
				       <tr> 
				       ...
				       <tr>
				       		<td><?php echo Base_Controller::ToggleLang('Cheque Date').": <u>".  Util::displayFormat($form2->cheque_date) . "</u>";?></td>
				       		<td colspan="2"><?php echo Base_Controller::ToggleLang('Present Date').": <u>".  Util::displayFormat($form2->cheque_present_date) . "</u>";?></td>
				       </tr>
				       <?php }?>
				       <tr> 
