				...
				<table class="table table-condensed">
					<tbody>
				       <tr> 
					       	...
					       	<td><input type="text" class="form-control" id="grade_name" name="grade_name" value='<?php echo $_GET['grade_name'];?>'  /></td>
				       	</tr>
				       	<tr> 
				       		<td><?php echo Base_Controller::ToggleLang('Min Scores');?></td>
					       	<td><input type="text" class="form-control" id="min_scores" name="min_scores" value='<?php echo  $_GET['min_scores'];?>'  /></td>
				       	</tr>
				       <tr>
				       		<td></td>
				       		<td>
			       				...
			       				<input type="hidden" class="form-control" id="grade_name" name="grade_name_old" value='<?php echo $_GET['grade_name'];?>' />
				       		</td>				       		
				       </tr>
					</tbody>
				</table>
