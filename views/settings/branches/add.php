	...
	?>
		<div class="form-body">
					...
					<div class="form-group">
						<select name="company_id" class="form-control" id="company_id" >
		                    ...
		                    <?php foreach($company_list as $comp){ 
		                    	...
		                    	?> 
		                    	<option value="<?php echo $comp_id;?>" <?php if($comp_id ==  $this->session->userdata(SESSION_CONST_PRE.'company_id')) echo 'selected'; ?> ><?php echo $comp->name;?></option>
		                    <?php } ?>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="name" data-required="1" class="form-control" placeholder="Enter Name" value="">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" name="arabic_name" class="form-control" placeholder="Enter Arabic Name" value="">
						<span class="help-block"></span>
					</div>
				</div>
			</div>
