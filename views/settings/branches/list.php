					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="cursor:pointer">
                        <tr>
                          ...
                          if(isset($division_list) && sizeof($division_list) > 0){
                          	$i=0;
                          	foreach($division_list as $values){
                          		$i++;
                          ...
                          ?>
	                          <tr>
	                            <td class="<?php echo $class; ?>"><input type="checkbox" name="selected_id_<?php echo $i;?>" id="selected_id_<?php echo $i;?>" value="<?php echo $values->division_id;?>" /></td>
