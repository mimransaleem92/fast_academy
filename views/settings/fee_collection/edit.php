<div class="col-md-12">
	<div class="portlet box blue">
		...
		<div class="portlet-body">
			...
			<?php 
			echo form_open('fee_collection/update',array('id'=>'mainForm', 'class'=>"form-horizontal"));
			$form = $form[0];
			...
			?>
				<div class="form-body">
							...
							<div class="form-group">
								<select name="fee_category_id" class="form-control" id="fee_category_id" onchange="onchange_fee_category(this.value)">
				                    ...
				                    <?php foreach($fee_category_list as $category){ 
				                    	...
				                    	?> 
				                    	<option value="<?php echo $category_id;?>" <?php if($category_id == $form->fee_category_id) echo 'selected';?>><?php echo $category->category_name. '-' . $category->batch_name;?></option>
				                    <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								<input type="text" class="form-control" placeholder="<?php echo Base_Controller::ToggleLang('Collection Name');?>" name="collection_name" id="collection_name" value='<?php if(isset($form->collection_name)) echo $form->collection_name;?>' />
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<div class="form-group">
								<input type="text" class="form-control form-control-inline date-picker" data-date-format="dd-mm-yyyy" size="16" placeholder="dd-mm-yyyy" name="due_date" id="due_date" value='<?php if(isset($form->due_date)) echo $form->due_date;?>' />
								<span class="help-block"><?php echo form_error('end_date');?></span>
							</div>
						</div>
					</div>			
