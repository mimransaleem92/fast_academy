				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="institute" name="institute" value='<?php echo $pre_data->institute;?>' placeholder="<?php echo Base_Controller::ToggleLang('Institute');?>" />
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" name="course" id="course" value='<?php echo $pre_data->course;?>' placeholder="<?php echo Base_Controller::ToggleLang('Course');?>" />
								<!-- <span class="help-block">This is inline help</span> -->
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" name="total_marks" id="total_marks" value='<?php echo $pre_data->total_marks;?>' placeholder="<?php echo Base_Controller::ToggleLang('Total Marks');?>" />
