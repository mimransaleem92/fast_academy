					...
					?>
						...
						<div class="form-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" readonly="readonly" id="student_name" name="student_name" value='<?php echo $form->student_name;?>' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-8">
											<?php $ariars = 0;
											$title_ariars = ''; $due_amount = 0; $paid_fee = 0; $discount_amount = 0;
							...
							<div class="row">
									...
									<div class="form-group" >
										...
										<div class="col-md-6" >
											...
											/*  Tuition Fee" selected > Tuition Fee </option>
				                          	...
				                          	$tuition_fee = $transport_fee = $edu_plus_fee = 0;
				                          	if(isset($pending_fee_list) && sizeof($pending_fee_list) > 0){  
				                          		foreach($pending_fee_list as $values){
				                          			...
				                          			if($values->fee_desc == 'Tuition Fee'){
				                          				...
				                          				$tuition_fee = ($values->due_total - $values->total_payment - $values->total_discount);
				                          			}
												...
												//echo $num;
												?>
												<input type="hidden" id="first_term" value="<?php echo $first_term_fee;?>" />
												<input type="hidden" id="tuition" value="<?php echo $tuition_fee;?>" />
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control <?php if($super_admin == 'Y') echo 'form-control-inline date-picker'?>" data-date-format="dd-mm-yyyy" readonly="readonly" id="payment_date" name="payment_date" value='<?php echo date('d-m-Y');?>' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Fee Month');?>:</label>
										<div class="col-md-6">
											<select name="fee_term" class="form-control" id="fee_term" data-placeholder="Choose a fee term" tabindex="1" >
							                    ...
							                    // value of fee term is made by concate first digit from the division of the student like DIS=2 or DNS=1 ?>
							                    <!--<option value="10" <?php //if($ariars > 0) echo 'selected'; else echo 'disabled="disabled"';?> > Arrears </option>
							                    <option value="11" <?php //if($ariars == 0 && $due_fee > 0 && $first_term_fee < $tuition_fee) echo 'selected'; //else echo 'disabled="disabled"';?>> 1st Term </option>
							                    <option value="12" <?php //if($ariars == 0 && $due_fee > 0 && $first_term_fee > $tuition_fee) echo 'selected'; //else echo 'disabled="disabled"';?>> 2nd Term </option>
							                    <option value="13"> Full Session </option> -->
							                    <?php $arr_m = array('--','Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec');
												for($m = 4; $m <= 12; $m++){
													echo '<option value="'.$m.'" > '.$arr_m[$m].' </option>';
												}
												?>
							                    <option value="99" > Next Session </option>
											</select>
								...
								if( $student_division == 'DNS' ){
									...
									if($ariars > 0 || $due_fee == 0 || ($ariars == 0 && $due_fee > 0 &&  $cheque !='' ) ){
										...
										<div class="col-md-8">
											<div class="clearfix">
												<div class="radio-list" >
													...
													<input type="radio" name="payment_amt" id="payment_amt100" value="100" checked > Full
													</label>
													<?php $super_admin = $this->session->userdata(SESSION_CONST_PRE.'super_admin'); 
													$manual_fee = $this->session->userdata(SESSION_CONST_PRE.'manual_fee_receive');
													if($super_admin == 'Y' || $manual_fee == 'Y'){ ?>
													<label class="radio-inline" style="<?php if($admin_role == '0') echo 'display:none;'?>" onclick="onclick_payment();" title="Manual Amount">
													<input type="radio" style="<?php if($admin_role == '0') echo 'disabled="disabled";'?>" name="payment_amt" id="payment_amt999" value="999" > Manually
													</label><?php } ?> 
												</div> 
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<select name="fee_desc" class="form-control" id="fee_desc" data-placeholder="Choose a fee type" onchange="set_payment_amount(this);" tabindex="1" >
							                    ...
							                    <option value="Test Fee" > Test Fee </option>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<?php  $payment_amount = 0;
												...
												elseif($due_fee>0)
												{
													if($first_term_fee > $tuition_fee) 
														$payment_amount = $tuition_fee;
													else 
														$payment_amount = $first_term_fee;
												}
												?>
											<input type="hidden" id="payment_amount_hidden" value='<?php echo $payment_amount;?>' />
											<input type="text" class="form-control" disabled="disabled" style="text-align: right; padding-right: 4px" onkeyup="onkeyup_payment(this, event);" id="payment_amount" name="payment_amount" value='<?php echo $payment_amount;?>' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row" >
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control popovers" data-trigger="hover" data-container="body" data-placement="top" data-content="10% discount allowed on Payment amount. If payment is full then upto 15%" data-original-title="Info" style="text-align: right; padding-right: 4px" id="discount_amount" name="discount_amount" onkeyup="onkeyup_discount(this, event);" value="0" />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-md-5">
											<select name="payment_mode" class="form-control" id="payment_mode" onchange="onchange_mode(this.value);" data-placeholder="Choose a Payment Mode" tabindex="1" >
							                    ...
							                    <option value="Cash" disabled="disabled" > Cash </option>
							                    <?php }?>
										...
										<div class="btn-group col-md-1" data-toggle="buttons">
											<label class="btn default" onclick="onclick_second_source(this)" >
											<input type="checkbox" class="toggle" id="second_source" > Second </label>
										</div>
									</div>
								</div>
								<!--/span-->
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Amount Received');?>:</label>
										<div class="col-md-6">
							...
							<!--/row-->
							<div class="row" id="cc_cheque_option_row">
								<div class="col-md-6">
									<div class="form-group">
							...
							<div class="row" id="cheque_option_row">	
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Present Date');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="cheque_present_date" name="cheque_present_date" value='<?php if($due_fee>0) echo util::displayFormat($cheque_date);?>' />
										</div>
									</div>
								</div>
							</div>
							...
							<!--/row-->
							<div class="row" style="display:none" id="second_source_row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Second Payment');?>:</label>
										<div class="col-md-6">
											<select name="payment_mode_second" class="form-control" id="payment_mode_second" onchange="onchange_mode_second(this.value);" >
							                    <?php if($super_admin == '00'){?>
							                    <option value="Cash" selected > Cash </option><?php }?>
								...
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Second Amount');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control" style="text-align: right; padding-right: 4px" id="cheque_amount_second" name="cheque_amount_second" value='0' />
										</div>
									</div>
								</div>
							...
							<!--/row-->
							<div class="row" style="display:none" id="cc_cheque_option_row2">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Card / Cheque No');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control" id="card_number_second" name="card_number_second" value="" />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							<div class="row" style="display:none" id="cheque_option_row2">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Cheque Date');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="cheque_date_second" name="cheque_date_second" value='<?php ?>' />
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Present Date');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="cheque_present_date_second" name="cheque_present_date_second" value='' />
										</div>
									</div>
								</div>
							</div>
							<!--/row-->
							<div class="row" style="display:none" id="cc_option_row2">
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Transaction No');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control" id="card_transaction_no_second" name="card_transaction_no_second" value='' />
										</div>
									</div>
								</div>
								<!--/span-->
								<div class="col-md-6">
									<div class="form-group">
										<label class="control-label col-md-4"><?php echo Base_Controller::ToggleLang('Auth. Code');?>:</label>
										<div class="col-md-6">
											<input type="text" class="form-control" id="auth_code_second" name="auth_code_second" value='' />
											<!-- <span class="help-block">This is inline help</span> -->
										</div>
									</div>
								</div>
							...
							?>
							<div class="row" id="garantee_row1" style="display:none; <?php echo $first_row;?>" >
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-md-2">
											<input type="text" class="form-control" id="cheque_amount1" name="cheque_amount1" style="text-align: right" value="<?php if($ratio == 0 || $ratio == 50) echo ($tuition_fee - $payment_amount);?>" placeholder="0.00"/>
										</div>
										<div class="col-md-2">
...
<script src="<?php echo base_url();?>assets/scripts/app.js"></script>	
		<script> 
	        ...
	        function submitForm(){
	        	...
	        	if(document.getElementById('payment_amt100').checked){
	        	...
	        	var cheque_amt = parseFloat(document.getElementById('cheque_amount').value);
	        	var cheque_amt_2nd = parseFloat(document.getElementById('cheque_amount_second').value);
	        	var cheque_date = document.getElementById('cheque_date').value;
	        	var present_date = document.getElementById('cheque_present_date').value;
				if(document.getElementById('payment_amt100').checked){
					allowed_discount = parseFloat(0.15*payment_amt);
				}
	        	var sum_payments = cheque_amt + cheque_amt_2nd + parseFloat(discount_amt);				
				...
				else if(payment_amt != sum_payments ){
					document.getElementById('error1').innerHTML="Sum of the received amounts must be equal to Payment Amount or After Discount(if any).";
					error1.show();
					$('#cheque_amount').closest('.form-group').addClass('has-error');
					$('#cheque_amount_second').closest('.form-group').addClass('has-error');
	    	    	return false;
				}
				else if(payment_mode == 'Cheque' && (card_num == '' || cheque_date == '' || present_date == '')){
					$('#payment_amount').closest('.form-group').removeClass('has-error');
					//$('#cheque_option_row').addClass('has-error');
					if(card_num == ''){
						$('#card_number').closest('.form-group').addClass('has-error');
					}else if(cheque_date == ''){
						$('#cheque_date').closest('.form-group').addClass('has-error');
					}else if(present_date == ''){
						$('#cheque_present_date').closest('.form-group').addClass('has-error');
					}/* else if(cheque_amount == '' || cheque_amount <= 0){
						$('#cheque_amount').closest('.form-group').addClass('has-error');
					} */
					return false;
				}
				else if((payment_mode == 'Span' ||  payment_mode == 'VISA' || payment_mode == 'Credit Card' || payment_mode == 'Master Card' || payment_mode == 'American Express') && (card_trans == '' || auth_code == '')){
					$('#payment_amount').closest('.form-group').removeClass('has-error');
					if(card_trans == '') {
	        ...
	        function onclick_payment(){
	        	var fee_type = document.getElementById('fee_desc').value;
				...
				if(fee_term <= 9){ // Ist Term
					if(fee_type == '1'){ // Tuition 
						fee_amount = first_term;
					}
					
				}
				else if(fee_term == '12'){ // 2ns Term
					if(fee_type == '1'){ // Tuition 
						fee_amount = document.getElementById('tuition').value;
					}
				}else if(fee_term == '13'){ // Full Paid
					fee_amount = due_fee;
				}
				var discount_amt = document.getElementById('discount_amount').value;
				if(arrears > 0){
	        		...
	        		document.getElementById('payment_amount').value = parseFloat(fee_amount);
	        ...
	        function onkeyup_payment(obj, e){
	        	var discount_amount = parseFloat(document.getElementById('discount_amount').value);
	        	var payment_amount = parseFloat(obj.value);
	        	var amt = parseFloat(0.10*payment_amount);
				if(document.getElementById('payment_amt100').checked){
					amt = parseFloat(0.15*payment_amount);
				}
		        if(discount_amount <= amt){
		        	//alert(obj.value + " and "  + amt);
		        	error2.hide();
		        	$('#discount_amount').closest('.form-group').removeClass('has-error');
	        		document.getElementById('discounted_amount').value = payment_amount - parseFloat(discount_amount);
		        }
		        else{
		        	error2.show();
	        	 	App.scrollTo(error1, -200);
	        ...
	        function set_payment_amount(obj){
	        	onclick_payment();
	        	var mode_obj = document.getElementById('payment_mode');
	        	var x = obj.value;
	        	if(x <= 3){
	        		...
	        		document.getElementById('payment_amount').disabled = true;
	        		mode_obj.options[0].selected = true;
					mode_obj.options[0].disabled = false;
	        ...
	        function onchange_mode(val){
	        	...
	        	document.getElementById('cc_cheque_option_row').style.display = "block";
	        	if(val == 'Cash'){
					document.getElementById('payment_mode').options[0].selected = true;
	        		document.getElementById('cc_option_row').style.display = "none";
	        		document.getElementById('cheque_option_row').style.display = "none";
	        		document.getElementById('cc_cheque_option_row').style.display = "none";
	        	}
	        	else if(val == 'Span' ||  val == 'VISA' || val == 'Credit Card' || val == 'Master Card' || val == 'American Express'){
	        ...
	        function onchange_mode_second(val){
	        	document.getElementById('cc_option_row2').style.display = "none";
	        	document.getElementById('cheque_option_row2').style.display = "block";
	        	document.getElementById('cc_cheque_option_row2').style.display = "block"; // common for both cc & cheque
	        	if(val == 'Cash'){
	        		document.getElementById('cc_option_row2').style.display = "none";
	        		document.getElementById('cheque_option_row2').style.display = "none";
	        		document.getElementById('cc_cheque_option_row2').style.display = "none";
	        	}
	        	else if(val == 'Span' ||  val == 'VISA' || val == 'Credit Card' || val == 'Master Card' || val == 'American Express'){
	        		document.getElementById('cc_option_row2').style.display = "block";
	        		document.getElementById('cheque_option_row2').style.display = "none";
	        		document.getElementById('card_number_second').select();
	        		document.getElementById('card_number_second').focus();
	        	}
	        }

	        function onclick_second_source(obj){
	        	document.getElementById('second_source_row').style.display = "none";
	        	document.getElementById('cc_option_row2').style.display = "none";
        		document.getElementById('cheque_option_row2').style.display = "none";
        		document.getElementById('cc_cheque_option_row2').style.display = "none";
        		document.getElementById('payment_mode_second').options[0].selected = false;
        		document.getElementById('second_source_hidden').value="N";
		        if(document.getElementById('second_source').checked){
		        	onchange_mode_second('Cheque');
		        	
		        	document.getElementById('second_source_hidden').value="Y";
	        		document.getElementById('second_source_row').style.display = "block";
		        }
	        }
	        
	        <?php if($form->enable_cash_payment == 'Y' || $super_admin == 'Y')  //make 00 to Y in above stmt
				{ ?>
        		document.getElementById('payment_mode').options[0].disabled = false;
        	<?php }?>
			onchange_mode('Cash');
        </script> 
