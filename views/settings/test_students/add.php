...
<div class="portlet box green">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<?php $today = date('Y-m-d'); echo form_open('test_students/add', array('id'=>'mainForm', 'enctype'=>"multipart/form-data", 'class'=>"form-horizontal")); ?>
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<select name="admission_term" class="form-control" id="admission_term" data-placeholder="Choose a fee term" tabindex="1" >
									...
									for($m = 1; $m <= 12; $m++){
										$s = ($m == date('m')) ? 'selected' : '';
										echo '<option value="'.$m.'" '.$s .'> '.$arr_m[$m].' </option>';
									}?>
								</select>
							</div>
							<div class="col-md-2"></div>
