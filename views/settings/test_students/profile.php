...
<div class="tabbable tabbable-custom boxless">
	...
	<div class="tab-content">
		...
		<?php $today = date('Y-m-d'); 
			echo form_open('test_students/add',array('id'=>'mainForm'));
		?>
					...
					<div class="panel-group accordion scrollable" id="accordion2">
						...
						<div class="panel panel-default">
							...
							<div id="collapse_2_2" class="panel-collapse collapse">
								<div class="panel-body">
									<?php echo form_open('test_students/update_monthly_subjects',array('id'=>'subForm', 'class'=>"form-horizontal")); ?>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-4">Continue Study</label>
												<div class="col-md-6">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label col-md-4">Test Started</label>
												<div class="col-md-4">
													<select class="form-control" name="test_started" id="test_started" > 
														<option> </option>
														<?php 
														for($m = 1; $m <= 12; $m++){
														    $selected =  ($form->test_started == $m) ? 'selected' : '';
