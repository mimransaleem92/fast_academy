    ...
    <script src="<?php echo base_url();?>assets/global/scripts/util.js" type="text/javascript"></script>
	...
	var cal_params = ['wo_date','invoice_date', 'date', 'from_date', 'to_date', 'delivery_date','iqama_expiry', 'passport_expiry', 'joining_date', 'date_of_birth',
	               'applied_date','create_date', 'start_month', 'last_working_day','leave_date','admission_date',
