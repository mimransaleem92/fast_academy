...
<table border="0" width="100%" cellpadding="5" cellspacing="0" style="font-weight: bold;font-style: bold;">
	<thead>
	<?php if (!is_null($this->emp_info) && isset($this->emp_info[0])){
		...
		<tr>
			<td align="left" width="120px" nowrap="nowrap"> Requested By: </td>					
		...
		<tr>
			<td align="left" nowrap="nowrap"> Department: </td>				
			<td align="left"  nowrap="nowrap"> 
				<?php echo $emp->DEP_NAME?> 
			</td>
		</tr>	
		<?php }
		}
