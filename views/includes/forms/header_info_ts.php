...
function printUrl($formId,$ownerId){
	$url = "index.php?option=com_timesheet&view=timesheetprint&format=raw&formType=Time Sheet&formId=".$formId."&emp_num=".$ownerId;
	return $url."&pt=1";
}
...
<?php if(!$pt){?>
	<tr>
		<td align="right"  colspan="2"> <a href="#" onclick=' javascript: window.open("<?php echo printUrl($this->formId,$this->ownerId); ?>","PrintView"); ' > Print Form </a> </td>
	</tr>
<?php }?>
