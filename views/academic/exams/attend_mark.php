			...
			<table width="100%" cellspacing="0" cellpadding="4" border="0" class="whitebgBorder"> 
				...
				<?php $total_marks =50; ?>
				      <tr>	
				      	...
				      	<td><input type="text" class="form-control input-sm" onkeypress="keyPressAllow(event,this, '<?php echo $total_marks?>');" style="text-align: right" id="obtained_marks" name="obtained_marks" value='' /></td>
