		...
		<div style="width:1250px;">
			...
			<div style="height: 100px; padding-top: 10px;" >
				...
				<table border="0" width="100%" style="margin-top: -70px; font-family: 'Times New Roman', Times, serif;" >
					<thead>
						<tr>
							<th width="8%"></th>
							<th width="80%" style="text-align: center; text-transform: uppercase; font-size: 22px;"> <?php echo $school_title;?> </th>
							<th width="12%"></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td></td>
							<td style="text-align: center; font-size: 14px;"> <?php echo 'Test result for '.$course_name;?> </td>
							<td></td>
						</tr>
					</tbody>
				</table>
			...
			<table border="1" style="border: 2px solid #000; width: 100%; background-color: #FFF; color: #000;">
				<tr style="border-bottom: 2px solid #000; width: 100%; background-color: #FFF; color: #000;" >
					...
					<th colspan="<?php echo sizeof($subject_list)*2+2;?>" style="text-align: center;" ><?php echo Base_Controller::ToggleLang('Obtain Marks');?></th>
				</tr>
				<tr style="border-bottom: 2px solid #000; width: 100%; background-color: #FFF; color: #000;">
					<?php foreach($subject_list as $sub){ 
							...
							<th style="text-align: center; width: 80px;" title="<?php echo $sub->subject_name;?>" ><?php echo $sub->subject_code;?></th>
					<?php } ?>
				...
				<tr>
					...
					<td style="padding-left: 4px" nowrap="nowrap"><?php echo $student->admission_number;?></td>
					<td style="padding-left: 4px; padding-right: 4px" nowrap="nowrap"><?php echo $student->student_name;?></td>
					<?php foreach($subject_list as $sub){ 
								$sid = $sub->subject_id;
