						...
						<div class="row alert alert-info cl-md-12" id="tbl_marksheet" >
					 		<table border="1" style="border: 2px solid #000; width: 100%; background-color: #FFF; color: #000;">
				                	...
				                	if(isset($student_list) && sizeof($student_list)>0)
				                	{
			                    		...
			                    		{ 	$i++;
			                    		 	$obtain_marks = $row->obtain_marks+150;
			                    		   	$average_marks = ($subject_count > 0) ? ($row->obtain_marks*100) / ($subjects_total-150) : '0'; 
				                    ...
				                    <tr>
			                			...
			                			<td style="text-align: center;"><?php echo $obtain_marks//.'*'.$subject_count.'*'.$average_marks;?></td>
			                			...
			                			<td style="text-align: center;"><a class="btn default btn-xs green-stripe" href="#" onclick="window.open('<?php echo base_url()."term_report/print_view/".$row->student_id;?>', '_blank')">View</a></td>
			                		</tr>	
				                    <?php }
				                    } ?>
				        	</table>	
