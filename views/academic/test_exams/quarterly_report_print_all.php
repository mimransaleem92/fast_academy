	...
	<div class="col-md-12">
		...
		<?php $form = null;
			...
			if($form->division_id == '1'){
				...
				$background_image = base_url()."assets/images/report_header_vis_final.png";
				$school_title = APP_TITLE;
				$address_line1 = "american_curriculum";
				$address_line2 = ( $form->course_id < 12 ) ? "license_no_117s" : 'license_no_4350140114';
			}
					...
					<tbody>
						<tr>
							...
							<td style="text-align: center;">
								<?php //$term_name = (isset($_GET['term']) && $_GET['term'] == '2' ) ? 'Second' : 'First';
									  $term_arr = array('1'=>'First', '2'=>'Second', '3'=>'Third', '4'=>'Fourth');
