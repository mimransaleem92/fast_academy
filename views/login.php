...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo" style="background-color: #F7F7F7; padding: 5px 30px 5px; width: 360px;text-align:left">
		<img src="<?php echo base_url();?>assets/admin/layout/img/logo-big.png" alt="" /> 
		<!--<img src="<?php echo base_url();?>assets/img/logo_fast.png" alt="" /> -->
	</div>
	<br />
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="login-form" action="<?php //echo $_SERVER['PHP_SELF'].""; ?>" method="post">
			...
			<div class="alert alert-danger <?php echo (!empty($errorMessage)) ? '' : 'display-hide'; ?>">
				<button class="close" data-close="alert"></button>
				<span><?php echo (!empty($errorMessage)) ? Base_Controller::ToggleLang($errorMessage) : 'Enter Username and password!';?></span>
			</div>
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		<?php echo date('Y');?> &copy; Web Serve
	</div>
	<!-- END COPYRIGHT -->
