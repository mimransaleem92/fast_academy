...
<div class="col-md-12">
	...
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption"><?php echo Base_Controller::ToggleLang('Student Interview List');?></div>
			...
			<table class="table table-condensed table-hover" >
				<thead>
					<tr>
						...
						<th><?php echo Base_Controller::ToggleLang('Documents');?></th>
					</tr>
				</thead>
				<tbody>
		        ...
		        <?php
		            ...
		            <tr>
		            	<!-- <td ><input type="checkbox" name="selected_id_<?php echo $i;?>" id="selected_id_<?php echo $i;?>" <?php //if($values->status == 'Issued') echo 'disabled="disabled"';?> value="<?php echo $values->enrollment_id;?>" /></td> -->
		             	...
		             	<td><?php echo $values->document_received?></td>	                          
		        	</tr>
		            <?php 	}
		            }
		    	?></tbody>
