						...
						<table width="100%" border="0" cellspacing="3" cellpadding="0"  align="center">
				            <tr style="font-weight: bold">
	                            ...
	                            <?php $search_param = ""; $title = "by ";
	                            	echo Base_Controller::ToggleLang('Test Fee Report'); ?></td>
	                            <td  width="30%" ></td>
                          	</tr>
                        ...
                        <thead class="flip-content"><tr >
							...
							<th><?php echo Base_Controller::ToggleLang('Stationary');?></th>
							<th><?php echo Base_Controller::ToggleLang('Academy');?></th>
                          </tr></thead>
                  		<?php
                  		  $i=0; $msg_flag = TRUE; $total_payment = 0;
                  		  $total_mode1 = $total_mode2 =$total_mode3 = 0;
                          ...
                          ?>
	                          <tr>
								...
								<td align="right" ><?php echo number_format(($values->payment_amount- $statinary )*(0.70), 2);?></td>
								<td align="right" ><?php echo number_format($statinary, 2);?></td>
								<td align="right" ><?php echo number_format(($values->payment_amount- $statinary)*(0.30), 2);?></td>
	                          </tr>
	                  <?php 	}
                          }
                       ?>
                      	<tr>
							...
							<td align="right" ><b><?php echo number_format($total_mode3, 2);?></b></td>
                    	</tr>
	                </table>
					<?php if($msg_flag) {?>
