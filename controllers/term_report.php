...
class Term_report extends Base_Controller{
	...
	function index(){
		...
		if(isset($row[0])){
			...
			$this->load_template('academic/exams/term_report_card');
		}
		else{
	...
	function print_view(){
		...
		$this->load->view('academic/exams/term_report_print_view', $this->data);
	}
